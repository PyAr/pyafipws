...
formatos_dir = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "..", "formatos")
)
...
class TestLeerFunction:
    def test_leer_csv_file(self):
        ...
        expected_data = [
            [
                ...
                "",
                "889.82",
                "Patricia 1 - Cdad de Buenos Aires - 1405 - Capital Federal - "
                "Argentina",
                "1076.68",
                "0",
                "30 Dias",
    ...
    def test_leer_csv_custom_delimiter(self):
        """
        Test that the leer function can read a CSV file with
        a custom delimiter.
        """
        sample_csv_data = (
    ...
    def test_leer_csv_with_header(self):
        """
        Test that the leer function can read a CSV file
        with a header row correctly.
        """
        sample_csv_data = (
            "Column1,Column2,Column3\n"
            "Value1,Value2,Value3\n"
    ...
    def test_leer_csv_without_header(self):
        """
        Test that the leer function can read a CSV file
        without a header row correctly.
        """
        sample_csv_data = (
            "Value1,Value2,Value3\n"
            "Value4,Value5,Value6"
    ...
    def test_leer_csv_with_whitespace(self):
        """
        Test that the leer function can handle leading/trailing whitespace
        in CSV values correctly.
        """
        sample_csv_data = (
            "Column1,Column2,Column3\n"
            "Value1 , Value2 , Value3 \n"
    ...
    def test_leer_csv_with_non_string_values(self):
        """
        Test that the leer function can handle non-string
        values in a CSV file correctly.
        """
        sample_csv_data = (
            "Column1,Column2,Column3\n"
            "1,2.5,True\n"
    ...
    def test_leer_csv_different_dialect(self):
        """
        Test that the leer function can handle a CSV file
        with a different dialect correctly.
        """
        sample_csv_data = (
            "Column1;Column2;Column3\n"
            "Value1;Value2;Value3\n"
    ...
    def test_leer_xlsx_file_with_header(self):
        """
        Test that the leer function can read an Excel file
        with a header row correctly.
        """
        expected_data = [
            ["Value1", "Value2", "Value3"],
    ...
    def test_aplanar_multiple_records(self):
        ...
        expected_data = [
            ...
            [
                ...
                5,
                42,
                [{"iva_id": 5, "base_imp": 200, "importe": 42}],
                None,
                None,
                None,
                None,
...
class TestDesplanarFunction:
    def test_desaplanar_single_record(self):
        ...
        a single record from flattened format to structured format.
        """
        filas = [
            [
                "id",
        ...
        expected_data = [
            {
                ...
                "ivas": [{"iva_id": 5, "base_imp": 100, "importe": 21}],
                "permisos": [],
                "opcionales": [],
                "cbtes_asoc": [],
                "forma_pago": "Contado",
    ...
    def test_desaplanar_multiple_records(self):
        """
        Test that the desaplanar function correctly converts
        multiple recordsfrom flattened format to structured format.
        """
        filas = [
            [
                "id",
        ...
        expected_data = [
            ...
            },
            {
                ...
                "ivas": [{"iva_id": 5, "base_imp": 200, "importe": 42}],
                "permisos": [],
                "opcionales": [],
                "cbtes_asoc": [],
                "forma_pago": "Tarjeta de Crédito",
...
class TestEscribirFunction:
    ...
    def test_escribir_facturas_xlsx(self):
        """
        Test that the escribir function can write data from
        facturas.csv to an XLSX file correctly.
        """
        # Read the contents of facturas.csv
        with open("datos/facturas.csv", "r", newline="") as file:
            csv_reader = csv.reader(file, delimiter=";")
