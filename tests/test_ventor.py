...
with open('rei.crt', 'r', encoding='utf-8') as f:
    rei_crt = f.read()
    
with open('rei.key', 'r', encoding='utf-8') as f:
    rei_key = f.read()
...
def test_files_vs_certs():
    assert rei_crt == ('-----BEGIN CERTIFICATE-----'
    ...
    assert rei_key == ('-----BEGIN RSA PRIVATE KEY-----'
